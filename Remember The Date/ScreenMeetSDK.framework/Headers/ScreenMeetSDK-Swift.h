...
+ (NSDictionary * _Null_unspecified)usage;
+ (void)setUsage:(NSDictionary * _Null_unspecified)value;
...
@interface NSCharacterSet (SWIFT_EXTENSION(ScreenMeetSDK))
@end


@interface NSData (SWIFT_EXTENSION(ScreenMeetSDK))
@end
...
SWIFT_CLASS("_TtC13ScreenMeetSDK7SSLCert")
...
SWIFT_CLASS("_TtC13ScreenMeetSDK11SSLSecurity")
...
/// 
/// </code>
SWIFT_CLASS("_TtC13ScreenMeetSDK19SocketClientManager")
...
@interface SocketEngine (SWIFT_EXTENSION(ScreenMeetSDK))
